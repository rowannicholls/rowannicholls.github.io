...
- Round brackets with three elements:
    - An initialisation of a *counter* (a variable that counts the number of iterations that have occurred)
    - A 'continue condition' (the condition for which the loop will continue to repeat)
