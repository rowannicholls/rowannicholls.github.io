...
To **update Sublime Text 4** on macOS Big Sur:

- Open Sublime Text and, if an update is available, you should get a prompt inviting you to download it
- Click "Download"
- Click "Install"
...
- *Ubuntu 20.04*
    ...
    - To **update Sublime Text 4**:
        + Open Sublime Text and, if an update is available, you should get a prompt inviting you to download it ("A new version of Sublime Text is available, download now?")
...
sudo apt-get install sublime-text
            ```
        - Sometimes it takes a few days for the latest Sublime Text version to be available for Ubuntu. In other words, even if you follow the above steps, you might still see the "A new version of Sublime Text is available, download now?" prompt. You just have to live with that.
- *Ubuntu 18.04*
