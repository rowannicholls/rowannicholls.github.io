...
### Installation
On **macOS**, download Sublime Text 4 from its [download page](https://www.sublimetext.com/download). All versions of OS X/macOS from 10.9 onwards are supported. After installing it, check that it's worked by opening the terminal (Cmd+Space to open Spotlight Search then search for "terminal") and running:
