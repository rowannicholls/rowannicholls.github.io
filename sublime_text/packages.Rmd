...
- **Pretty JSON**
    ...
    - This command used to have a keybinding assigned to it automatically, but this is no longer the case. It can be added manually, however, by going to Preferences > Key Bindings. In the right-hand side (the user keybindings file) paste:
    ```json
        /* Pretty JSON */
