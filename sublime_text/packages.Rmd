...
- Install the linters on your computer through pip:
    ...
    ```bash
    # Replace "python3.13" with your version of Python
    $ python3.13 -m pip install flake8
    $ python3.13 -m pip install pycodestyle
    $ python3.13 -m pip install pydocstyle
    $ python3.13 -m pip install bandit
    $ python3.13 -m pip install pyflakes
    ```
