...
6. Agreement *(incl accuracy, precision (repeatability and reproducibility), variability and equivalence):*
    ...
    - Correlation Coefficients:
        - [Pearson Correlation Coefficient, *r*](python/statistics/agreement/pearsons_r.html)
        - [Spearman's Rank Correlation Coefficient, *ρ*](python/statistics/agreement/spearmans_rho.html)
