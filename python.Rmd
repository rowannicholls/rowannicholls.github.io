...
## Curve Fitting
1. Linear Functions
    - [Comparison of Methods](python/curve_fitting/linear_comparison.html)
    - [Linear Regression](python/curve_fitting/linear_regression.html)
...
2. [Combinations and Permutations](python/statistics/combinations_permutations.html)
...
4.  Hypothesis Testing:
    ...
    - t-Tests
        ...
        - [Two One-Sided t-Test (TOST)](python/statistics/hypothesis_testing/tost.html)
