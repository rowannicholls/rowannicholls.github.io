...
7. [Date and Time (Part 1)](python/intro/date_time.html)
...
3. [Date and Time (Part 2)](python/advanced/date_time.html)
4. [Parsing Command-Line Arguments](python/advanced/argument_parsing.html)
5. [Python vs R](python/advanced/python_vs_r.html)
