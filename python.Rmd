...
4. Date and Time:
    ...
    <!-- - [Timezones] -->
    <!-- - [Calendars] -->
5. [Args and Kwargs](python/intermediate/args_kwargs.html)
<!-- 6. Python and the Terminal -->
<!--     - Parsing Command-Line Arguments -->
<!--     - Run Terminal Commands in Python -->
<!--     - Prompt for User Input -->
7. [Parsing Command-Line Arguments](python/intermediate/argument_parsing.html)
<!-- 8. [Webscraping] -->
<!-- 9. [Bitwise Operators] -->
10. [Error Handling](python/intermediate/error_handling.html)
<!-- 11. [Linting] -->
<!-- 12. [Variable Scope] -->
13. [Package Management and Virtual Environments](python/intermediate/packages_and_venvs.html)
...
- [Merging](python/data_frames/merging/index.html)
