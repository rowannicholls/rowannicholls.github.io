...
## Advanced Python
1. [Nested Lists and List Comprehensions](python/advanced/lists.html)
2. [Nested Dictionaries and Dictionary Comprehensions](python/advanced/dictionaries.html)
3. Data Frames:
...
7. [Parsing Command-Line Arguments](python/advanced/argument_parsing.html)
<!-- 8. [Webscraping] -->
<!-- 9. [Bitwise Operators] -->
10. [Error Handling](python/advanced/error_handling.html)
<!-- 11. [Linting] -->
<!-- 12. [Variable Scope] -->
13. [Package Management and Virtual Environments](python/advanced/packages_and_venvs.html)
...
8. [Exploratory Data Analysis (EDA)](python/data/exploratory_data_analysis.html)
...
## Image Analysis
1. [Working With Images](python/image_analysis/working_with_images.html)
    - [Working With DICOMs](python/image_analysis/working_with_dicoms.html)
2. [Filtering](python/image_analysis/filtering.html)
3. [Posterise](python/image_analysis/posterise.html)
4. [Segmentation via Selecting by Colour](python/image_analysis/segmentation.html)
5. [Calculating Overlap and the Dice Coefficient](python/image_analysis/dice_coefficient.html)
6. [Compare Two Images](python/image_analysis/comparing_two_images.html)
7. [Taking Screenshots](python/image_analysis/screenshots.html)
8. [Click to Interact with an Image](python/image_analysis/click_to_interact.html)
9. [Analysis of Pixel Values](python/image_analysis/pixel_analysis.html)
10. [Computer Vision](python/image_analysis/computer_vision.html)
