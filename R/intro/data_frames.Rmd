...
The columns "Streams_Millions" and "Release_Date" have been changed to "Streams_Millions" and "Release_Date".
...
```{r}
df <- dplyr::arrange(spotify, Artist, Streams_Millions)
```
...
```{r}
df <- dplyr::arrange(spotify, desc(Artist))
```
