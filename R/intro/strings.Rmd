...
## Formatted Output
If you want to print a variable as part of a string using a specific format, use the `printf()` function along with the `%` character to indicate where you want the variable to be inserted. You also need to have a letter after the `%` to indicate what type of format to use.
