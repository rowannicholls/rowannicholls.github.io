...
If you are moving to a new major version (eg from 3.5 to 4.0) then not all packages will work, even if you attempt to update them. The easiest thing to do is to delete all of them (ie delete all folders inside the /usr/local/lib/R/site-library folder) and re-install them from scratch.
