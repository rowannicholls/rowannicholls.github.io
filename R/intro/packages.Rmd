...
Import a Library
================
When you want to use functionality that is part of a particular package, you need to import the package as a library in the script by using the `library()` function:
