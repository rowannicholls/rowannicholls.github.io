...
> For each of 18 players and the three methods tested, the average time of two runs from a point on the first base line 35 ft from home plate to a point 15 ft short of second base is recorded.
...
# GET THE DEGREES OF FREEDOM OF THE APPROXIMATE CHI-SQUARED DISTRIBUTION OF THE TEST STATISTIC
df = f$parameter
...
Using Vectors Instead of a Data Frame
=====================================
The above test was done using the entire data frame `rounding_times` as the input to the function. To instead do it with vectors is a simple case of calling the 
