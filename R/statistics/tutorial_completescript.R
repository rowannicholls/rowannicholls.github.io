...
p = p + geom_boxplot()
p = p + ggtitle("Were the Titanic's passengers more likely to survive if they had paid more?")
p = p + xlab('')
print(p)
...
p = p + geom_segment(aes(x=1, xend=0, y=0, yend=1), color='grey', linetype='dashed')
