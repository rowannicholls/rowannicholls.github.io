...
p = p + geom_curve(aes(x=18, y=29.5, xend=18, yend=45.5), curvature=0.67, ncp=50)
p = p + geom_curve(aes(x=57.5, y=47.5, xend=57.5, yend=27.5), curvature=1, ncp=50)
p = p + geom_vline(xintercept=57.5)
p = p + geom_curve(aes(x=57.5, y=27.5, xend=57.5, yend=47.5), curvature=1, ncp=50)
p = p + geom_curve(aes(x=97, y=45.5, xend=97, yend=29.5), curvature=0.67, ncp=50)
