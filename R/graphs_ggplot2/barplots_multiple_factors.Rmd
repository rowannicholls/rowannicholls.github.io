...
p <- p + xlab("Age")
p <- p + labs(
    title = "Age of passengers on the Titanic", y = "Count", fill = "Class"
)
print(p)
```
...
p <- p + xlab("Class")
p <- p + labs(
    title = "Class of passengers on the Titanic", y = "Count", fill = "Gender"
)
print(p)
```
...
p <- p + xlab("Gender")
p <- p + labs(
    title = "Gender of passengers on the Titanic", y = "Count",
    fill = "Survived"
)
print(p)
```
...
p <- p + xlab("Survived")
p <- p + labs(
    title = "Survival of passengers on the Titanic", y = "Count", fill = "Age"
)
print(p)
```
