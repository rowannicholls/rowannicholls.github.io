...
p = p + labs(title="Student's Sleep Experiment", y='Additional Sleep Time [hr]', fill='Medicine')
print(p)
```
...
# TITLES AND LABELS
p = p + xlab('Medicine')
p = p + labs(title="Student's Sleep Experiment", y='Additional Sleep Time [hr]')
# REMOVE LEGEND
...
There are too many factors to plot all at once: on a 2D graph only two can be shown at once:
...
p = p + xlab('Age')
p = p + labs(title='Age of passengers on the Titanic', y='Count', fill='Class')
print(p)
```
...
p = p + xlab('Class')
p = p + labs(title='Class of passengers on the Titanic', y='Count', fill='Gender')
print(p)
```
...
p = p + xlab('Gender')
p = p + labs(title='Gender of passengers on the Titanic', y='Count', fill='Survived')
print(p)
```
...
p = p + xlab('Survived')
p = p + labs(title='Survival of passengers on the Titanic', y='Count', fill='Age')
print(p)
```
