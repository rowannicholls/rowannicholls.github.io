...
Latex in Labels
---------------
By using the `latex2exp` package, you can use the full power of Latex to generate proper-looking labels:
...
y = x**2
plot(
    x, y, type = "l", main = TeX("y = x and y = x^2"),
    xlab = "x-values", ylab = "y-values"
)
# Plot a straight line
y = x
...
# Import raw data
data = read.csv(
    "https://github.com/rowannicholls/rowannicholls.github.io/blob/master/R/graphs/base/Week-by-Week%20Points.csv?raw=true",
    check.names = FALSE
)
```
