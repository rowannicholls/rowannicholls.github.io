...
An better approach is to show the bars side-by-side:
...
There are too many factors to plot all at once; on a 2D graph only two can be shown at once. That's no problem though because we can just make four:
