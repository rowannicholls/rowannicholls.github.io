...
From Long to Wide
=================
For this example we will use the ["Gapminder" dataset](https://cran.r-project.org/web/packages/gapminder/README.html), which can be installed as follows:
...
long <- gather(
    wide, keycol, valuecol, all_of(gathercols), factor_key = TRUE
)
head(long)
```
