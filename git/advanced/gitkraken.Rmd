...
### Update
- On **Ubuntu**:
    - Download the latest version as a .deb file from the GitKraken [website](https://www.gitkraken.com/download/linux-deb)
    + Install it from the terminal with `sudo dpkg -i gitkraken-amd64.deb`
