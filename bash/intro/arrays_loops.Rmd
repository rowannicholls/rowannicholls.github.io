---
title: '<font size="5">Introduction to Bash:</font><br>Arrays and Loops'
output:
    html_document:
        theme: paper
        highlight: textmate
...
Arrays and Lists
================
'Arrays' and 'lists' are data types in Bash, just like strings, numbers, nulls and Booleans. Fundamentally, they are both *collections of elements* separated by spaces. Arrays are created using round brackets and lists with quotation marks:
...
Remember that Bash uses *zero-indexing*, so the first element is in position zero and the number 6 is actually at index 2, not 3! Notice also that you need to include the curly brackets when making this call; if you leave them out Bash will look for a variable called "numbers[2]" instead of a variable called "numbers".
