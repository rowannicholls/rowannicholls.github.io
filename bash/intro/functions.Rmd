---
title: '<font size="5">Introduction to Bash:</font><br>Creating a Function'
output:
    html_document:
        theme: paper
        highlight: textmate
...
Defining a Function
===================
Here's the format of a function in Bash:
