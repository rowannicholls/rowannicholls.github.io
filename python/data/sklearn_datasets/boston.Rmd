...
[https://scikit-learn.org/stable/datasets/toy_dataset.html?highlight=boston#boston-house-prices-dataset](https://scikit-learn.org/stable/datasets/toy_dataset.html?highlight=boston#boston-house-prices-dataset){target="_blank"}

The **Boston house prices dataset** is loaded using `load_boston()`. This
