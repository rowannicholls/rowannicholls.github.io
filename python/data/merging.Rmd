...
Concatenation
=============
Concatenating two data frames is actually *not* the same as merging them, it's simply combining them by sticking one next to the other. It's done using the `concat()` function:
