...
# Create a data frame
raw = pd.DataFrame({
    'only_trues': [True, True, True],
    'only_falses': [False, False, False],
    'only_text': ['Value 1', 'Value 2', 'Value 3'],
    'falses_and_null': [False, False, None],
    'falses_and_nan': [False, False, np.NaN],
    'text_and_null': ['Value 1', 'Value 2', None],
})
...
raw['falses_and_null'] = raw['falses_and_null'].astype('category')
