---
title: '<font size="5">Data Handling in Python:</font><br>Look Up Sunrise and Sunset Times'
output:
    html_document:
        theme: paper
        highlight: textmate
...
- Install: `pip install astral` or `pip3 install astral`
...
print(f'Dates: {ls_of_ls[0][:5]}')
print(f'Sunrises: {ls_of_ls[1][:5]}')
print(f'Sunsets: {ls_of_ls[2][:5]}')
```

```{python, iterate_copy, echo = FALSE, results = "hide"}
import numpy as np
...
## Sunrises: ['06:19 BST', '06:20 BST', '06:22 BST', '06:23 BST', '06:25 BST']
## Sunsets: ['19:50 BST', '19:49 BST', '19:47 BST', '19:44 BST', '19:42 BST']
```
