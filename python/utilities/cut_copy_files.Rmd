...
Following on from [this page](the_os_module.html) about the `os` module, here's how to cut and copy files in Python:
...
# Source file
src = 'Source Folder/example_file.txt'
# Destination file
dst = 'Destination Folder/example_file.txt'
...
src = 'Destination Folder/example_file.txt'
dst = 'Source Folder/example_file.txt'
os.rename(src, dst)
...
```{python, echo = FALSE}
os.rmdir(Path('Destination Folder', 'sub_folder'))
time.sleep(3)
```
...
```
## Copying "Source Folder/example_file.txt" to "Destination Folder/example_file.txt"
## Copying "Source Folder/sub_folder/example_file.txt" to "Destination Folder/sub_folder/example_file.txt"
```
