---
title: '<font size="5">Data Frames with `Pandas`</font><br>Merging'
output:
    html_document:
        theme: paper
        highlight: textmate
...
> This page is the sixth in a series on data frames:
> 
...
<center>
![](merging/outer.png) ![](merging/left.png) <br>
![](merging/right.png) ![](merging/inner.png)
