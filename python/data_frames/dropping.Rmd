---
title: '<font size="5">Data Frames with `Pandas`</font><br>Dropping Empty Columns'
output:
    html_document:
        theme: paper
        highlight: textmate
...
Where `python3.13` is the version of Python you are using (in my case it's 3.13 but replace this with what you have).
