---
title: '<font size="5">Advanced Python:</font><br>Nested Lists and List Comprehensions'
output:
    html_document:
        theme: paper
        highlight: textmate
...
Set Comprehension
=================
In the same way that you can create lists via list comprehensions, you can create sets using set comprehensions:

```{python}
ls = [1, 2, 3, 4, 5, 6]
# Find all numbers larger than 2
s = {value for value in ls if value > 2}
print(s)
```
