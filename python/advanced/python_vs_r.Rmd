---
title: '<font size="5">Advanced Python:</font><br>Python vs R'
output:
    html_document:
        theme: paper
        highlight: textmate
...
Dictionaries
------------
This object type in Python is extremely useful and although [it IS possible to re-create this functionality in R](../../R/intro/named_vectors_lists.html) it is clumsy. The ability to use strings as keys also leverages the fact that strings have more usability in Python compared to R (see "string manipulation" and "consistent string handling" above).
