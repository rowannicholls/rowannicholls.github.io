...
# TITLES
ax.set_title('Long Jump Finals at the Last Four Olympic Games')
ax.set_ylabel('Distance [m]')
...
# AXIS DETAILS
ax.set_title('Long Jump Finals at the Last Two Olympic Games')
ax.set_ylabel('Distance [m]')
ax.tick_params(axis='x', bottom=False)
xticks = ax.set_xticks(np.arange(len(list(datasets[0]))) + 1)
xticks = ax.set_xticks(np.arange(len(list(datasets[0])) + 1) + 0.5, minor=True)
...
# AXIS DETAILS
ax.set_title("Men's Finals at the Last Two Olympic Games")
ax.set_ylabel('Distance [m]')
ax.set_xlabel('Event')
ax.tick_params(axis='x', bottom=False)
xticks = ax.set_xticks(np.arange(len(list(datasets[0]))) + 1)
