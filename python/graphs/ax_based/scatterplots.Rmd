...
- Change the **marker colour and type** using the `c` and `m` keyword arguments in the `ax.scatter()` call (see [this page](../symbols_linestyles_colours.html) for all the colour and marker options)
...
ax.set_xlabel(r'Time, $t$ [\textmu s]')
