...
- Turn minor tick markers on (`minorticks_on()`) but then turn them off for the x-axis (`tick_params()`)
...
plt.subplots_adjust(
    left=0.1, right=0.98, top=0.95, bottom=0.1, wspace=0.5, hspace=0.5
)
