...
```{python fig.height=-1}
plot_colortable(
    mcolors.BASE_COLORS, 'Base Colors', sort_colors=False, emptycols=1
)
plt.show()
```
...
The Matplotlib documentation is [here](https://matplotlib.org/3.1.0/gallery/color/named_colors.html).
