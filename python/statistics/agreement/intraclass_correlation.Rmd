...
----------------------
The source code for this function might be useful if you want to take a look at how exactly it works. That can be found over [here](https://pingouin-stats.org/_modules/pingouin/reliability.html#intraclass_corr).
