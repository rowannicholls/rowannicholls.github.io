...
print(f'agreement = {agreement}, by_chance = {by_chance}, kappa = {kappa}')
```
...
print(
    f'p_o = {p_o}, p_e = {p_e}, kappa = {kappa:3.1f}\n',
    f'standard error = {se}\n',
    f'lower confidence interval = {lower}\n',
    f'upper confidence interval = {upper}', sep=''
)
```
...
print(
    ...
    f'standard error = {se}\n',
    f'lower confidence interval = {lower}\n',
    f'upper confidence interval = {upper}',
    sep=''
)
```
