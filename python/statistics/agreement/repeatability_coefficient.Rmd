...
A Special Case
--------------
In the special case where the measurements are performed exactly twice on each measurand the above equation can be re-written as follows[^7] [^8]:
...
[^7]: Bland JM, Altman DG. Statistical methods for assessing agreement between two methods of clinical measurement. Lancet. 1986 Feb;327(8476):307–10. DOI: [10.1016/S0140-6736(86)90837-8](https://pubmed.ncbi.nlm.nih.gov/2868172/). [Online](https://www-users.york.ac.uk/~mb55/meas/ba.pdf).
...
[^10]: Van Noorden R, Maher B, Nuzzo R. The top 100 papers. Nature. 2014;514:550-3. [Online](https://www.nature.com/news/the-top-100-papers-1.16224).
[^11]: Bland JM, Altman DG. Measuring agreement in method comparison studies. Stat Methods Med Res. 1999;8(2):135–60.
