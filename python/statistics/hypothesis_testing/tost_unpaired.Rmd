---
title: '<font size="5">Statistics in Python:</font><br>Unpaired Two One-Sided t-Test (TOST)'
output:
    html_document:
        theme: paper
        highlight: textmate
...
> This page is about the *unpaired* two one-sided t-test ('unpaired TOST'). The *paired* two one-sided t-test ('paired TOST') is covered on [this](tost_paired.html) page.
...
The test was originally published by Donald J Schuirmann (not Donald **L** Schuirmann as appears in the [R](https://www.rdocumentation.org/packages/equivalence/versions/0.7.2/topics/tost.stat) and [Pingouin](https://pingouin-stats.org/build/html/generated/pingouin.tost.html) documentation):
