...
Let's use the following hypothetical example which comes from Giavarina (2015)<sup>2</sup>. Imagine that a set of objects were each measured twice - once using 'Method A' and once using 'Method B' - giving the two lists of measurements below:
...
# Reference line
ax.plot(
    [left, right], [left, right], c='grey', ls='--', label='Reference line'
)
# Legend
