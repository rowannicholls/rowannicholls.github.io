---
title: '<font size="5">Curve Fitting in Python:</font><br>Linear Functions'
output:
    html_document:
        theme: paper
        highlight: textmate
...
ax.plot(x, gradient * x + intercept, 'k', label='Fitted curve')
...
ax = plt.axes()
ax.scatter(x, y, label='Raw data')
ax.plot(x, 2 * x + 10, 'k--', label='True underlying relationship')
ax.plot(x, predict_y, 'k', label='Line of best fit')
ax.set_title('Example Data')
ax.set_ylabel('y-Values')
ax.set_xlabel('x-Values')
ax.set_ylim(0)
...
ax.scatter(x, y, label='Raw data')
ax.plot(x, 2 * x + 10, 'k--', label='True underlying relationship')
ax.plot(x, m * x + c, 'k', label='Line of best fit')
ax.set_title('Example Data')
ax.set_ylabel('y-Values')
ax.set_xlabel('x-Values')
ax.set_ylim(0)
