...
Have a look at [this page](../advanced/error_handling.html) for ideas about how to *handle* errors, and how to write code to use them to your advantage. In the meantime, have a look down this list of *all* the built-in errors that exist in Python, which comes from the [documentation](https://docs.python.org/3/library/exceptions.html):
