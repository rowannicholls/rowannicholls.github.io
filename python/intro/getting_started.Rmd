...
Ubuntu
------
The following works for Ubuntu 16.04 to 18.04.

### Installing and Setting up
- There is no need to install Python on Ubuntu: it comes already installed. In fact, multiple versions of Python come pre-installed (these multiple installations can be found in the /usr/bin/ folder)
