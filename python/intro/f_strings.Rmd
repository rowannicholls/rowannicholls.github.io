...
====================
A f-string is created by appending the letter "f" to the front of a string and then adding the name of an already-defined variable between curly bracket. The value of that variable will then get incorporated into the string itself.
...
Multiple arguments can be incorporated into an f-string, and these can be numbers or strings:
