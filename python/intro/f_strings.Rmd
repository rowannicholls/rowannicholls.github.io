...
Formatting Dates
================
Things such as `datetime` objects can also be formatted within the curly brackets of an f-string. Here's an example of a normal (unformatted) `datetime` object (more info about these can be found on the [Date and Time page](../advanced/date_time.html)):
