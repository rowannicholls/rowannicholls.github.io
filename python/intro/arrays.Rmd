...
This object `ar` is more memory-efficient than a list would have been. The `i` that has been used is the *type code* which specifies what data type will apply for all elements in the array. In this case they will be *signed integers*. For all the available type codes, see [the documentation](https://docs.python.org/3/library/array.html).
