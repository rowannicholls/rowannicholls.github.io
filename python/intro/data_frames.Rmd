...
```{python, eval = FALSE}
# Import comma-separated values (.csv file) as a data frame
data_url = 'https://raw.githubusercontent.com/rowannicholls/rowannicholls.github.io/master/python/data/csv/data%20frame.csv'
df_downloaded = pd.read_csv(data_url)
print(df_downloaded)
```
...
```{python, echo = FALSE}
# Undo
df = df.drop(['e in name?', 'Sub-10'], axis=1)
```
