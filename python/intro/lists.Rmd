...
Again, this has acted *in-place* and only on the *first* occurrence of the value. To remove multiple values from a list at a time (ie remove a list from a list) one option is to use a list comprehension:
...
Alternatively, you could use a **set** - see [the section below](#removing-multiple-values-from-lists) where these are covered.
