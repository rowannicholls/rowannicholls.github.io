...
- Use the `datetime` module if you want to work with times and dates like you would see on a clock or on a calendar, or with durations. This module is discussed on its [own page](../advanced/date_time.html).
